...
interface IProductUseCase {
    ...
    suspend fun getCooperationData(cooperationId: String): Response<CooperationResponse>
    suspend fun getTransactionByUserId(userId: String): Response<TransactionResponse>
